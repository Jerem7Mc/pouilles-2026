...
export const LIEUX: readonly Lieu[] = [
  ...
  },
  {
    ...
    note: 'Quatre compagnies au même endroit, à 1,9 km du logement, 24 minutes à pied ou un bus urbain. Trenitalia pour Trani, Polignano, Monopoli, Ostuni et Lecce. FAL pour Matera, bornes grises. FSE pour Alberobello. Ferrotramviaria pour l’aéroport.',
    lat: 41.11767,
    lon: 16.87007,
    precision: 'poi',
  ...
  },
  {
    ...
    note: 'Trenitalia depuis Bari, et FSE pour Gallipoli. 1,1 km jusqu’au logement, 13 minutes à pied. Au sud du centre.',
    lat: 40.34568,
    lon: 18.16572,
    precision: 'poi',
    jours: [J7, J8, J11],
  ...
  // ==========================================================
  {
    id: 'the-queen-room-bari',
    nom: 'The Queen Room Bari',
    type: 'hebergement',
    ville: 'Bari',
  ...
  // ==========================================================
  {
    ...
    type: 'supermarche',
    ville: 'Bari',
    adresse: 'Via Napoli, Bari',
    note: 'Le plus proche du logement : 147 m, 2 minutes à pied. Eau, en-cas du soir, courses de base.',
    lat: 41.12734,
    lon: 16.84987,
    precision: 'poi',
    jours: JOURS_BARI,
  ...
  {
    id: 'dok-brigata-regina',
    nom: 'Supermercati Dok',
    type: 'supermarche',
    ville: 'Bari',
    adresse: 'Via Brigata Regina 12, Bari',
    note: '503 m, dans la rue du logement. Repli si le Coop est fermé, notamment pendant la pause de l’après-midi.',
    lat: 41.12325,
    lon: 16.85171,
    precision: 'poi',
    jours: JOURS_BARI,
  },
  {
    ...
    note: 'Loin du logement, 1,9 km, mais à 200 m de la gare de Bari Centrale : c’est celui qu’on croise au retour d’excursion, pas celui du soir.',
    lat: 41.11676,
    lon: 16.86845,
    precision: 'poi',
    jours: JOURS_BARI,
  },
  {
    ...
    note: '2,2 km du logement, mais proche de la gare. Choix plus large de spécialités régionales sèches : pâtes, taralli. À privilégier pour les souvenirs comestibles, en fin de séjour.',
    lat: 41.11625,
    lon: 16.87219,
    precision: 'rue',
    jours: JOURS_BARI,
  },
  {
    ...
    type: 'supermarche',
    ville: 'Lecce',
    adresse: 'Via Novantacinquesimo Reggimento Fanteria 1, Lecce',
    note: 'Le plus proche du logement : 354 m, 5 minutes à pied. C’est ici qu’on prépare le pique-nique de Porto Cesareo, la veille au soir.',
    lat: 40.35179,
    lon: 18.17731,
    precision: 'poi',
    jours: JOURS_LECCE,
  },
  {
    ...
    note: 'Meilleur rapport prix de Lecce, mais 1,1 km du logement : à faire une fois, pas tous les soirs.',
    lat: 40.34931,
    lon: 18.18551,
    precision: 'rue',
    jours: JOURS_LECCE,
