...
export const LIEUX: readonly Lieu[] = [
  ...
  // ==========================================================
  {
    ...
    note: '6 nuits du 24 au 30 août, quartier Libertà. Compter 1,8 km jusqu’à la gare de Bari Centrale, soit 22 minutes à pied : à prévoir les matins de départ en excursion. Position calée sur le n°79 voisin, le n°88 n’est pas cartographié.',
    lat: 41.12643,
    lon: 16.85181,
    precision: 'rue',
    jours: JOURS_BARI,
  },
  {
    ...
    note: '4 nuits du 30 août au 3 septembre, en plein centre historique, rue piétonne. 1,1 km de la gare, 14 minutes à pied. Le City Terminal, d’où partent les bus pour Otrante et Porto Cesareo, est à 1,2 km dans l’autre sens.',
    lat: 40.35308,
    lon: 18.17353,
    precision: 'rue',
    jours: JOURS_LECCE,
  ...
  // ==========================================================
  {
    ...
    note: 'Le plus proche du logement : 191 m, 3 minutes à pied. Eau, en-cas du soir, courses de base.',
    lat: 41.12734,
    lon: 16.84987,
    precision: 'poi',
    jours: JOURS_BARI,
  },
  {
    ...
    note: '354 m, dans la rue du logement. Repli si le Coop est fermé, notamment pendant la pause de l’après-midi.',
    lat: 41.12325,
    lon: 16.85171,
    precision: 'poi',
    jours: JOURS_BARI,
  },
  {
    ...
    note: 'Loin du logement, 1,8 km, mais à 200 m de la gare de Bari Centrale : c’est celui qu’on croise au retour d’excursion, pas celui du soir.',
    lat: 41.11676,
    lon: 16.86845,
    precision: 'poi',
    jours: JOURS_BARI,
  },
  {
    ...
    note: '2 km du logement, mais proche de la gare. Choix plus large de spécialités régionales sèches : pâtes, taralli. À privilégier pour les souvenirs comestibles, en fin de séjour.',
    lat: 41.11625,
    lon: 16.87219,
    precision: 'rue',
    jours: JOURS_BARI,
